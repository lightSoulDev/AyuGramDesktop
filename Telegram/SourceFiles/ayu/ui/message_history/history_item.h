...
public:
	...
	OwnedItem(not_null<HistoryView::ElementDelegate *> delegate, not_null<HistoryItem *> data);
	...
	[[nodiscard]] HistoryView::Element *get() const { return _view.get(); }

	[[nodiscard]] HistoryView::Element *operator->() const { return get(); }

	[[nodiscard]] operator HistoryView::Element *() const { return get(); }
